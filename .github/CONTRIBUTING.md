...
git clone <https://github.com/hyperpolymath/branch-newspaper.git> cd
branch-newspaper
...
toolbox create branch-newspaper-dev toolbox enter branch-newspaper-dev
...
branch-newspaper/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/branch-newspaper/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/branch-newspaper/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/branch-newspaper/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/branch-newspaper/labels/perimeter-3) — Community sandbox scope
